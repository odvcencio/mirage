...
go run ./cmd/mirage train-manta-kodak -dir kodak -max-images 24 -steps 5000 -crop 256 -crop-mode random -random-crops-per-image 8 -resume runs/kodak-reference/mirage_v1_lambda_0p01.weights.mll -lambdas 0.01 -optimizer adam -lr 0.001 -out-dir runs/kodak-long
go run ./cmd/mirage eval-manta-kodak -dir kodak -run-dir runs/kodak-reference -out-dir runs/kodak-eval
go run ./cmd/mirage fetch-compressai-baseline -out-dir baselines/compressai -qualities 1,2,3,4,5,6,7,8
