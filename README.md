...
go run ./cmd/mirage train-manta-kodak -dir kodak -max-images 24 -steps 5000 -crop 256 -crop-mode random -random-crops-per-image 8 -resume runs/kodak-reference/mirage_v1_lambda_0p01.weights.mll -lambdas 0.01 -out-dir runs/kodak-long
